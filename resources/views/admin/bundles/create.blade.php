...
<div class="admin-card">
    <div class="admin-card-header">
        <div>
            <h3 class="admin-card-title">Create Bundle</h3>
            <p class="admin-card-description">Add a new product bundle with selected items</p>
        </div>
    ...
    <div class="admin-card-body">
        ...
        <form method="POST" action="{{ route('admin.bundles.store') }}" enctype="multipart/form-data" id="bundle-form">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="admin-form-group">
                        ...
                        <input type="text" name="slug" value="{{ old('slug') }}" required class="admin-form-input" placeholder="Auto-generated from name">
                    </div>
                    <div class="admin-form-group">
                        <label class="admin-form-label">Bundle Price</label>
                        <input type="number" name="bundle_price" value="{{ old('bundle_price') }}" step="0.01" class="admin-form-input" placeholder="Leave empty for auto-calc">
                    </div>
                    <div class="admin-form-group">
                        <label class="admin-form-label">Sort Order</label>
                        <input type="number" name="sort_order" value="{{ old('sort_order', 0) }}" class="admin-form-input">
                    </div>
                    <div class="admin-form-group">
                ...
                <div>
                    <div class="admin-form-group">
                        ...
                        <textarea name="description" rows="4" class="admin-form-input"></textarea>
                    </div>
                </div>
            </div>
            ...
            <button type="submit" class="admin-btn admin-btn-primary">Create Bundle</button>
        </form>
    </div>
</div>
