        ...
        <div class="max-w-[1600px] mx-auto px-4 lg:px-8 h-11 flex items-center justify-between">
            <div class="hidden md:flex items-center gap-5">
                <div class="flex items-center gap-1.5 cursor-pointer">
                    <span
                        class="font-label-caps text-[11px] tracking-widest uppercase text-white/80 hover:text-white transition-colors">English</span>
                    <span class="material-symbols-outlined text-sm text-white/50">expand_more</span>
                </div>
                <span class="w-px h-3.5 bg-white/15"></span>
                <div class="flex items-center gap-1.5 cursor-pointer">
                    <span
                        class="font-label-caps text-[11px] tracking-widest uppercase text-white/80 hover:text-white transition-colors">$
                        Dollar (US)</span>
                    <span class="material-symbols-outlined text-sm text-white/50">expand_more</span>
                </div>
            </div>
            <div class="hidden md:flex items-center gap-2">
                <span class="font-label-caps text-[11px] tracking-widest uppercase text-white/70">Boost Your Daily
                    Routine! Use Code:</span>
                <span
                    class="inline-block border border-dashed border-primary/50 text-primary bg-primary/10 px-2.5 py-0.5 font-label-caps text-[11px] tracking-widest uppercase">HEALTH10</span>
            </div>
            <div class="flex md:hidden items-center">
                <span class="font-label-caps text-[10px] tracking-widest uppercase text-white/70">Code: <span
                        class="text-primary font-bold">HEALTH10</span></span>
            </div>
        ...
        <form class="hidden lg:flex flex-1 max-w-2xl mx-8" action="{{ route('shop') }}" method="GET">
            <div
                ...
                <div id="category-dropdown"
                    class="hidden absolute top-full left-0 mt-1 w-64 bg-white rounded-xl shadow-xl border border-[#999999]/20 z-50 py-2">
                    <div class="px-4 py-2">
